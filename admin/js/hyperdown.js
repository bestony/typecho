...
(function() {
    ...
    Parser = (function() {
        ...
        Parser.prototype.makeHtml = function(text) {
            ...
            for (j = 0, len = ref.length; j < len; j++) {
                ...
                if (parser[2] !== void 0) {
                    ...
                    this.parsers[name] = this[
                        "parseBlock" + ucfirst(name)
                    ].bind(this);
                }
            }
                ...
                (function(_this) {
                    return function() {
                        ...
                        if (id < 0) {
                            ...
                            _this.footnotes.push(
                                _this.parseInline(matches[1], "", false)
                            );
                        }
                        return _this.makeHolder(
                            '<sup id="fnref-' +
        ...
        Parser.prototype.parseBlock = function(text, lines) {
            ...
            for (key = l = 0, len1 = lines.length; l < len1; key = ++l) {
                ...
                if (this.current !== "normal") {
                    pass = this.parsers[this.current](
                        block,
                        key,
                        line,
                        state,
        ...
        Parser.prototype.parseBlockTable = function(
            block,
            key,
            line,
            state,
        ...
        Parser.prototype.parseBlockMh = function(
            block,
            key,
            line,
            state,
        ...
        Parser.prototype.parseShtml = function(lines, value, start) {
            return trim(
                this.markLines(lines.slice(1, -1), start + 1).join("\n")
            );
        };
